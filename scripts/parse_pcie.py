...
'''
I wrote this script as a wrapper around the 'fw_simple_v1.9.py' script,
...
below splits the data, runs the 'fw_simple_v1.9.py' script on all data collected,
...
# these are inherited from script 'fw_simple_v1.9.py'
